<template>
  <section>
    ...
    <el-table :data="pageInfo.rows" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="companyName" label="名称" width="100" sortable>
      </el-table-column>
      <el-table-column prop="companyNum"  label="电话" width="150" sortable>
      </el-table-column>
      <el-table-column prop="registerTime" label="注册时间" width="100" sortable>
      </el-table-column>
      <el-table-column prop="logo" label="头像" min-width="50" sortable>
<!--        <el-button type="primary" @click="submitUpload">修改</el-button>-->
        <template #default="scope">
          <img :src="scope.row.headImage" width="40" height="40" />
        </template>
      </el-table-column>
      <el-table-column prop="address" label="地址" min-width="50" sortable>
      </el-table-column>
      <el-table-column prop="employee.username" label="管理员" min-width="80" sortable>
      </el-table-column>
      <el-table-column prop="type.name" label="类型" min-width="80" sortable>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getEmployee() {
      ...
      this.$http.post("sys/tenant",this.query)
          .then(result => {
            result = result.data;
