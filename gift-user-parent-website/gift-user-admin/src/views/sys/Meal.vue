<template>
  <section>
    ...
    <el-table :data="pageInfo.rows" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="password"  label="电话" width="150" sortable>
        <template slot-scope="scope">
          <el-input v-model="scope.row.password" auto-complete="off" show-password class="borderNone"></el-input>
        </template>
      </el-table-column>
      <el-table-column prop="email" label="注册时间" width="100" sortable>
      </el-table-column>
...
<!--        <el-button type="primary" @click="submitUpload">修改</el-button>-->
      ...
      <el-table-column prop="age" label="地址" min-width="50" sortable>
      </el-table-column>
      <el-table-column prop="department.name" label="管理员" min-width="80" sortable>
      </el-table-column>
      <el-table-column prop="department.name" label="类型" min-width="80" sortable>
      </el-table-column>
