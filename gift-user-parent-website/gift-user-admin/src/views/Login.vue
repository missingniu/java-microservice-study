<template>
  <el-form :model="loginDto" :rules="rules2" ref="loginForm" label-position="left"
    ...
    <el-form-item style="width:100%;">
      <el-button type="primary" style="width:160px;" @click.native.prevent="handleSubmit2" :loading="logining">登录</el-button>
      <el-button type="primary" style="width:160px;" @click="handleSettlement" >租户入驻</el-button>
          ...
          this.$http.post("/login",this.loginDto)
              .then(result => {
                ...
                if(result.success){
                  ...
                  localStorage.setItem("loginUser",JSON.stringify(result.resultObject.loginUser));
